...
<div class="about-section">
  ...
  <div class="skills-bar">
    ...
    <div class="progress">
      <div class="progress-bar" style="width: 90%; background-color: #0056b3;">90%</div>
    </div>

    <p>📊 Data Analytics</p>
    <div class="progress">
      <div class="progress-bar" style="width: 85%; background-color: #28a745;">85%</div>
    </div>

    <p>🤖 AI Development</p>
    <div class="progress">
      <div class="progress-bar" style="width: 80%; background-color: #ffc107;">80%</div>
    </div>
  </div>
